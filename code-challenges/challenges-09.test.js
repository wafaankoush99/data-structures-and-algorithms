...
function transformToLis(obj){
  ...
  // console.log(o);
  return o.reduce(function(ac,it) {
    let b = `<li>${it[0]}: ${it[1]}</li>`;
    ac.push(b);
    return ac;
  } ,[]);
}
...
const addValues = (arr) => {
  // Solution code here...
  let n = arr.reduce(function(ac,it){
    ac=ac+it;
    return ac;
  },0);
  return n;
...
const addPurchases = (arr) => {
  // Solution code here...
  let n = arr.reduce(function(ac,itm){
    ac = ac+itm.purchasePrice;
    return ac;
  },0);
  return n;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let m = arr.reduce(function(ac,it){
    // console.log(it.name)
    ac.push(it.name);
    return ac;
  },[]);
