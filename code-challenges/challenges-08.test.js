...
function returnTen(str){
  // Solution code here...
  let n = str.split('');
  return n.slice((n.length - 10), n.length);
}
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let y = arr.filter(function(it){
    if (!forbiddenValues.includes(it)) return it;
  });
  return y;
};
